  ...
  <div class="container">
    ...
    <div class="">
      <div class="d-flex flex-column align-items-center justify-content-center my-5">
        ...
        <a href="#" class="p-2 px-5 m-2 text-decoration-none text-dark"><i style="margin-right:10px;" class="bi bi-bookmark"></i>Course</a>
        ...
        <a href="./login.php" style="margin-top:170px !important;" class="p-2 px-5 m-2 text-decoration-none text-dark">Logout<i style="margin-left:10px;" class="bi bi-door-closed"></i></a>
      </div>
    </div>
  </div>
